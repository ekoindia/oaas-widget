            ...
            React.createElement("div", { className: "flex-col" },
                ...
                React.createElement("div", { className: "sidebar_step_circl" },
                    ...
                    React.createElement("div", { className: "sidebar_step_indictr" },
                        currentStep > 1 ? stepsData.map((step) => step.id).indexOf(currentStep) + 1 : 0,
                        " Steps Completed")))),
        React.createElement("div", { className: "sidebar_step_name mb-10" }, (_a = steps === null || steps === void 0 ? void 0 : steps.filter((step) => step.isVisible)) === null || _a === void 0 ? void 0 : _a.map((step, i) => {
            return (React.createElement("span", { key: step.id, className: `step-item ${currentStep === step.id && 'active'} ${step.stepStatus === 3 && 'complete'}` },
                ...
                , null,
                    React.createElement("span", { className: "flex pb-5 items-center" },
                        React.createElement("span", { className: `step ${i > 0 && steps[i - 1].stepStatus == 0 ? 'disabled' : ''}` }, step.id >= currentStep ? i + 1 : React.createElement("img", { src: img$e, alt: "complete mark", className: "w-[15px] h-[11px]" })),
                        React.createElement("span", null,
                            React.createElement("p", { className: `sidebar_step_num ${i > 0 && steps[i - 1].stepStatus == 0 ? 'disabled' : ''}` }, step.label),
                            step.stepStatus > 1 && step.stepStatus < 3 && (React.createElement("div", { className: `stepStatus ${step.stepStatus === 2 ? 'text-red bg-white border-red border-2' : 'text-white bg-orange'}` }, step.stepStatus === 1 ? 'In Progress' : step.stepStatus === 2 ? 'Skipped' : '')))))));
        }))));
};
...
const Welcome = ({ stepData, handleSubmit }) => {
    ...
    return (React.createElement("div", { className: "welcome" },
        React.createElement("div", { className: "items-center text-center text-black" },
            React.createElement("img", { src: String(img$d), alt: "welcome icon", className: "welcome_img" }),
            ...
            React.createElement(ButtonGlobal, { className: "welcome_btn", 
                // onClick={() => {
...
const Uploadfile = ({ type, handleUpload }) => {
    ...
    return (React.createElement("label", { htmlFor: type, className: "documentbtn flex" },
        React.createElement("input", { type: "file", onChange: onSelectFile, name: type, id: type, style: { display: 'none' } }),
...
const Frontcam = ({ handleRetake, imageVal }) => {
    const { image, setImage, setCameraType } = useStore();
    console.log('imagesVal inside', imageVal);
    return (React.createElement("div", { className: "flex flex-col w-[50%] md:w-[100%] lg:w-[50%] sm:w-[100%] max-[450px]:w-[100%] max-[640px]:w-[100%] max-[640px]:mb-2 md:mb-2 sm:mb-2  mr-3" },
        React.createElement("div", { className: "w-full justify-center flex h-[190px]" },
            React.createElement("img", { src: imageVal || image, alt: "screenshot", className: "rounded-[10px] w-full" })),
...
const PanVerification = ({ stepData, handleSubmit, isDisabledCTA = false, shopTypes = [] }) => {
    ...
    const handleOnSubmit = () => {
        handleSubmit(Object.assign(Object.assign({}, stepData), { form_data: Object.assign({ panImage }, formValues), stepStatus: 3 }));
    };
    const handleSkip = () => {
    ...
    const handleImageUpload = (files, fileData) => {
    ...
    console.log('In pan shopTypes', shopTypes, shopTypes === null || shopTypes === void 0 ? void 0 : shopTypes.filter((shop) => shop.dependent_params.is_visible === 1));
    return (React.createElement("div", { className: "pt-8 sm:p-8 xl:w-[55%]" },
        ...
        React.createElement("div", null,
            ...
            React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "panNumber", value: formValues.panNumber, onChange: handleChange, id: "panNumber", type: "text", placeholder: "" })),
        React.createElement("div", { className: "relative sm:block mt-10" }, uploadedImage === 0 ? (cameraStatus === true && (panImage === null || panImage === void 0 ? void 0 : panImage.url) === null ? (React.createElement(Camera, { type: "pan", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: panImage })) : (React.createElement(React.Fragment, null, panImage.url !== null || undefined ? (React.createElement(Frontcam, { imageVal: panImage.url, handleRetake: () => handleRetake() })) : (React.createElement(React.Fragment, null,
            React.createElement("div", { className: "documentimgstyle overflow-hidden w-[100%]" },
                ...
                React.createElement("div", { className: "flex  mt-8" },
                    React.createElement(Uploadfile, { type: "pan", handleUpload: (files, fileData) => handleImageUpload(files, fileData) }),
        ...
        React.createElement("div", { className: "mt-2" },
            ...
            React.createElement("select", { name: "shopType", value: formValues.shopType, onChange: handleChange, id: "cars", className: "px-0.5 py-[9px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, (shopTypes === null || shopTypes === void 0 ? void 0 : shopTypes.length) > 0 &&
        ...
        React.createElement("div", { className: "mt-2" },
            ...
            React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shopName", value: formValues.shopName, onChange: handleChange, id: "shopName", type: "text", placeholder: "" })),
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", disabled: isDisabledCTA, onClick: handleOnSubmit }, isDisabledCTA ? 'Loading...' : primaryCTAText),
                ...
                React.createElement("div", { className: "modal_content shadow-lg" },
                    ...
                    React.createElement("div", { className: "modal_attntn" },
                        ...
                        React.createElement("div", { className: "mt-6 sm:mt-4" },
                            React.createElement("button", { className: "modal_attn_proc_btn", onClick: handleproceed }, "Yes, Proceed"),
                            React.createElement("button", { className: "modal_cancl_btn", onClick: () => setShowModal(false) }, "Cancel")))))),
...
const AdharVerifiction = ({ stepData, handleSubmit }) => {
    ...
    // }, [image]);
    const handleImageCapture = (image, fileData) => {
        setAadharImages(Object.assign(Object.assign({}, aadharImages), { [cameraType]: { url: image, fileData } }));
    };
    ...
    const handleOnclick = () => {
        ...
        handleSubmit(Object.assign(Object.assign({}, stepData), { form_data: { aadharImages }, stepStatus: 3 }));
    };
    const handleImageUpload = (files, type, fileData) => {
        console.log('files me hu', files, type, fileData);
        setAadharImages(Object.assign(Object.assign({}, aadharImages), { [type]: { url: files, fileData: fileData } }));
    };
    const handleRetake = (type) => {
        setAadharImages(Object.assign(Object.assign({}, aadharImages), { [type]: { url: null, fileData: null } }));
        setCameraStatus(true);
    };
    return (React.createElement("div", { className: "pt-8 sm:p-8 w-full" },
        ...
        React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row max-[640px]:flex  max-[640px]:items-center " },
            React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row w-[90%]" },
                cameraStatus === true && cameraType === 'front' && ((_a = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _a === void 0 ? void 0 : _a.url) == null ? (React.createElement(Camera, { type: "Aadhaar", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: aadharImages })) : (React.createElement(React.Fragment, null, ((_b = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _b === void 0 ? void 0 : _b.url) !== null || undefined ? (React.createElement(Frontcam, { imageVal: (_c = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _c === void 0 ? void 0 : _c.url, handleRetake: () => handleRetake('front') })) : (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "documentimgstyle xl:w-[50%] lg:w-[50%] md:w-[100%]  h-[190px] mr-4 sm:w-[100%] max-[640px]:mb-8 sm:mb-8 max-[640px]:mr-0  " },
                        ...
                        React.createElement("div", { className: "flex mt-4 ml-1.5" },
                            ...
                            React.createElement(ButtonGlobal, { className: "documentbtn", onClick: () => (setCameraStatus(true), setCameraType('front'), setImage(null)) },
                                React.createElement(React.Fragment, null,
                                    React.createElement("img", { src: img$b, className: "h-[2vh] mr-2" }),
                                    " Open Camera")))))))),
                cameraStatus === true && cameraType === 'back' && ((_d = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.back) === null || _d === void 0 ? void 0 : _d.url) == null ? (React.createElement(Camera, { type: "Aadhaar", cameraType: "back", handleImageCapture: handleImageCapture, imagesVal: aadharImages })) : (React.createElement(React.Fragment, null, ((_e = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.back) === null || _e === void 0 ? void 0 : _e.url) !== null || undefined ? (React.createElement(Backcam, { imageVal: (_f = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.back) === null || _f === void 0 ? void 0 : _f.url, handleRetake: () => handleRetake('back') })) : (React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "documentimgstyle xl:w-[50%] lg:w-[50%] md:w-[100%] h-[190px] mr-4 max-[640px]:mr-0  sm:w-[100%] " },
                        React.createElement("img", { src: img$c, className: "w-[2rem] h-[2rem] flex-col mb-4" }),
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleClickAdhar }, primaryCTAText),
            isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step"))),
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema$1, onSubmit: (formData) => {
            ...
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full" },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "alternate_mobile", value: values.alternate_mobile, onChange: handleChange('alternate_mobile'), id: "username", maxLength: "10", type: "tel", placeholder: "" })),
                React.createElement("div", null,
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "contact_person_cell", value: values.contact_person_cell, onChange: handleChange('contact_person_cell'), id: "username", maxLength: "10", type: "tel", placeholder: "" }),
            ...
            React.createElement(ButtonGlobal, { className: "welcome_btn", disabled: isDisabledCTA }, isDisabledCTA ? 'Loading...' : stepData === null || stepData === void 0 ? void 0 : stepData.primaryCTAText))))));
};
...
const VideoKYC = ({ stepData, handleSubmit, isDisabledCTA = false }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8 xl:w-4/5 md:w-full" },
        ...
        cameraStatus === true ? (React.createElement(Camera, { handleImageCapture: handleImageCapture, imagesVal: videoKyc, type: "videoRecor", cameraType: "front" })) : (React.createElement(React.Fragment, null,
            videoKyc.url !== null || undefined ? (React.createElement(Frontcam, { imageVal: videoKyc.url, handleRetake: () => handleRetake() })) : (React.createElement(React.Fragment, null,
            ...
            React.createElement("span", { className: `flex flex-col items-center sm:block mt-8` },
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleOnSubmit, disabled: isDisabledCTA }, isDisabledCTA ? 'Loading...' : primaryCTAText),
                isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step")))))));
};
...
const LoctionCapture = ({ stepData, handleSubmit, isDisabledCTA = false }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("ul", { className: "location_ul" },
...
const SignAgreement = ({ stepData, handleSubmit, isDisabledCTA = false, handleStepCallBack }) => {
    ...
    return (React.createElement("div", { className: "welcome" },
        React.createElement("div", { className: "items-center text-center text-black" },
            React.createElement("img", { src: "https://files.eko.co.in/docs/onborading/agreement.png", alt: "welcome icon", className: "welcome_img" }),
            React.createElement("p", { className: "sm:font-normal text-[18px] pt-2 pl-4 pr-4" },
                React.createElement("span", { className: "sm:block" }, "Happy to see you here. Lets start your onboarding journey."),
                React.createElement("span", { className: "sm:block" }, " We ensure, you'll be assisted at every step.")),
            React.createElement(ButtonGlobal, { className: "welcome_btn", disabled: isDisabledCTA, onClick: openPopupTab }, isDisabledCTA ? 'Loading...' : stepData === null || stepData === void 0 ? void 0 : stepData.primaryCTAText))));
};
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement("div", null,
                ...
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shopName", value: consentData, onChange: (e) => setConsentData(e.target.value), id: "username", type: "text", placeholder: "" })),
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleAadharConsentClick, disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
            isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step")))));
};

const ConfirmAadharNumber = ({ stepData, handleSubmit, isDisabledCTA }) => {
    const [aadharCardNumber, setAadharCardNumber] = useState('');
    const { label, description, isSkipable, primaryCTAText } = stepData;
    const handleConfirmAadharClick = () => {
        handleSubmit(Object.assign(Object.assign({}, stepData), { form_data: { aadhar: aadharCardNumber, is_consent: 'Y' }, stepStatus: 3 }));
    };
    const handleSkip = () => {
        handleSubmit(Object.assign(Object.assign({}, stepData), { stepStatus: 2 }));
    };
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement("div", { className: "mb-7 w-[80%] xl:w-[45%]" },
                React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Aadhar card Number"),
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shopName", value: aadharCardNumber, onChange: (e) => setAadharCardNumber(e.target.value), id: "username", type: "number", placeholder: "" })),
            ...
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px] mt-10", onClick: handleConfirmAadharClick, disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
            isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step")))));
};

const AadharNumberOtpVerify = ({ stepData, handleSubmit, isDisabledCTA }) => {
    const [otpVal, setOtpVal] = useState('');
    const [shareCode, setShareCode] = useState('');
    const { label, description, isSkipable, primaryCTAText } = stepData;
    const handleOtpAadharClick = () => {
        handleSubmit(Object.assign(Object.assign({}, stepData), { form_data: { otp: otpVal, is_consent: 'Y', share_code: shareCode }, stepStatus: 3 }));
    };
    const handleSkip = () => {
        handleSubmit(Object.assign(Object.assign({}, stepData), { stepStatus: 2 }));
    };
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("div", { className: "mt-10 relative" }),
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement("div", { className: "mb-7 w-[45%]" },
                React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "OTP"),
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "otp", value: otpVal, onChange: (e) => setOtpVal(e.target.value), id: "otp", type: "number", placeholder: "" })),
            React.createElement("div", { className: "mb-7 w-[45%]" },
                React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Share Code"),
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shareCode", value: shareCode, onChange: (e) => setShareCode(e.target.value), id: "shareCode", type: "number", placeholder: "" })),
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px] mt-10", onClick: handleOtpAadharClick, disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
            isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step")))));
};

const SignupSchema = create$3().shape({
    name: create$6().required('Required'),
    shop_address_line2: create$6().required('Required'),
    shop_address_pincode: create$6().required('Required'),
    sender_district: create$6().required('Required'),
    sender_state: create$6().required('Required')
});
...
const BusinessMerchant = ({ stepData, handleSubmit, isDisabledCTA = false, shopTypes = [], stateTypes = [] }) => {
    ...
    const onSuccess = (location) => {
        ...
        //     }
        // });
        setFormValues(Object.assign(Object.assign({}, formValues), { latlong: `${location.coords.latitude},${location.coords.longitude},${location.coords.accuracy}` }));
    };
    const onError = (error) => {
        console.log('Error in GeoLocation=>', error);
    };
    return (React.createElement(React.Fragment, null,
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema, onSubmit: (formData) => {
                ...
                handleSubmit(Object.assign(Object.assign({}, stepData), { form_data: Object.assign({}, formData), stepStatus: 3 }));
            ...
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full\t" },
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input mb-0", name: "name", value: values.name, onChange: handleChange('name'), id: "username", type: "text", placeholder: "" }),
                    errors.name && touched.name ? React.createElement("div", { className: "text-red" }, errors.name) : null),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Gender"),
                    React.createElement("select", { name: "gender", value: values.gender, onChange: handleChange('gender'), id: "cars", className: "px-0.5 py-2.5 border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, genderData.map((gender, idx) => {
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("select", { name: "businessType", value: values.businessType, onChange: handleChange('businessType'), id: "cars", className: "px-0.5 py-2.5 border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, companyTypeData.map((company, idx) => {
                        return (React.createElement("option", { value: company.value, key: `${idx}_${company.value}` }, company.label));
                    }))),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Business Address"),
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shop_address_line2", value: values.shop_address_line2, onChange: handleChange('shop_address_line2'), id: "username", type: "text", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shop_landmark", value: values.shop_landmark, onChange: handleChange('shop_landmark'), id: "username", type: "text", placeholder: "" })),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Pincode"),
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shop_address_pincode", value: values.shop_address_pincode, onChange: handleChange('shop_address_pincode'), id: "username", type: "number", placeholder: "", maxLength: 6, minLength: 6 }),
                ...
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "City"),
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "sender_district", value: values.sender_district, onChange: handleChange('sender_district'), id: "username", type: "text", placeholder: "" }),
                    errors.sender_district && touched.sender_district ? React.createElement("div", { className: "text-red" }, errors.sender_district) : null),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "State"),
                    React.createElement("select", { name: "sender_state", value: values.sender_state, onChange: handleChange('sender_state'), className: "px-0.5 py-2.5 border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, stateTypes.map((state, idx) => {
                        return (React.createElement("option", { value: state.value, key: `${idx}_${state.value}` }, state.label));
                    })))),
            React.createElement(ButtonGlobal, { className: "welcome_btn", disabled: isDisabledCTA }, isDisabledCTA ? 'Loading...' : stepData === null || stepData === void 0 ? void 0 : stepData.primaryCTAText))))));
};
    ...
    const renderStep = (currentStep) => {
        ...
        if (stepData) {
            switch (currentStep) {
                ...
                case 6:
                    return React.createElement(ConfirmAadharNumber, { stepData: stepData, handleSubmit: handleStepSubmit, isDisabledCTA: isDisable });
                case 7:
                ...
                React.createElement("div", { className: "containerboxover relative" },
                    React.createElement("div", { className: "sm:flex sm:justify-between" },
                        React.createElement("span", { className: "hidden sm:block md:block lg:block xl:block" },
                            React.createElement(Sidebar, { steps: steps })),
...
const Home = ({ defaultStep = '12400', handleSubmit, isBranding = true, stepResponse, shopTypes = [], selectedMerchantType, stateTypes = [], handleStepCallBack }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: `${currentStep === 0 ? 'bg-gray' : 'bg-white'} sm:bg-gray w-full min-h-screen` },
            ...
            React.createElement(HomePage, { sideBarToggle: sideBarToggle, setSideBarToggle: setSideBarToggle, handleSubmit: handleSubmit, stepResponse: stepResponse, shopTypes: shopTypes, stateTypes: stateTypes, selectedMerchantType: selectedMerchantType, handleStepCallBack: handleStepCallBack }))));
};
