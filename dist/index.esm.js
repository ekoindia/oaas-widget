        ...
        React.createElement("div", { className: "sidebar" },
            React.createElement("div", { className: "flex-col" },
                ...
                React.createElement("div", { className: "sidebar_step_circl" },
                    React.createElement("div", { ref: progressRef, className: `bg-green h-[12px] sm:h-2.5 rounded-full` }),
                    React.createElement("div", { className: "sidebar_step_indictr" },
                        currentStepIndex > 1 ? `${currentStepIndex} Steps` : '0 Step',
                        " Completed")))),
        React.createElement("div", { className: "sidebar_step_name mb-10" }, visibleStepData === null || visibleStepData === void 0 ? void 0 : visibleStepData.map((step, i) => {
            return (React.createElement("span", { key: step.id, className: `step-item ${currentStep === step.id && 'active'} ${step.id < currentStep && 'complete'}` },
                ...
                , null,
                    React.createElement("span", { className: "flex pb-5 items-center" },
                        React.createElement("span", { className: `step ${i > 0 && step.id > currentStep ? 'disabled' : ''}` }, step.id >= currentStep ? i + 1 : React.createElement("img", { src: img$e, alt: "complete mark", className: "w-[15px] h-[11px]" })),
                        React.createElement("span", null,
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8 xl:w-[55%] lg:w-[70%]" },
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: panSchema, onSubmit: (formData) => {
            ...
            React.createElement("div", null,
                ...
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "panNumber", value: values.panNumber.toUpperCase(), maxLength: "10", onChange: handleChange('panNumber'), id: "panNumber", type: "text", placeholder: "" }),
            ...
            React.createElement("div", { className: "mt-2" },
                ...
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shopName", value: values.shopName, onChange: handleChange('shopName'), id: "shopName", type: "text", placeholder: "" }),
        ...
        React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row max-[640px]:flex  max-[640px]:items-center " },
            React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row w-[90%]" },
                cameraStatus === true && cameraType === 'front' && ((_a = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.front) === null || _a === void 0 ? void 0 : _a.url) == null ? (React.createElement(Camera$1, { type: "Aadhaar", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: aadhaarImages })) : (React.createElement(React.Fragment, null, ((_b = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.front) === null || _b === void 0 ? void 0 : _b.url) !== null || undefined ? (React.createElement("div", { className: "flex flex-col w-[50%] md:w-[100%] lg:w-[50%] sm:w-[100%] max-[450px]:w-[100%] max-[640px]:w-[100%] max-[640px]:mb-2 md:mb-2 sm:mb-2  mr-3" },
                    ...
                    React.createElement("div", { className: "documentimgstyle   md:w-[100%]  h-[190px] sm:w-[100%]   " },
...
const PanAdharMatch = () => {
    ...
    return (React.createElement(React.Fragment, null, panStatus === 0 ? (React.createElement("ul", { className: "pt-2 pl-5 text-[16px] font-[300]" },
        ...
        React.createElement("span", { className: "w-[20%] sm:w-fit" },
            React.createElement("span", { className: "panaadhaar_thumb border-green" },
        ...
        React.createElement("span", { className: "w-[20%] sm:w-fit" },
            React.createElement("span", { className: "panaadhaar_thumb border-red" },
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema$1, onSubmit: (formData) => {
            ...
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full" },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "alternate_mobile", value: values.alternate_mobile, onChange: handleChange('alternate_mobile'), id: "username", maxLength: "10", type: "number", placeholder: "" })),
                React.createElement("div", null,
            ...
            React.createElement("span", { className: `${type === 'Pan' || type === 'videoRecord' ? 'flex justify-end' : 'flex'}` },
                React.createElement("div", { className: "flex flex-col mr-3" },
                    ...
                    React.createElement("div", { className: `flex justify-between mt-3` },
                        hasFlash && (React.createElement(ButtonGlobal, { onClick: toggleFlash, className: "cam_btn" },
                            React.createElement(React.Fragment, null,
                                "Turn Flash ",
                                flashOn ? 'Off' : 'On'))),
                        React.createElement(ButtonGlobal, { onClick: capture, className: "cam_btn" },
                            React.createElement(React.Fragment, null,
                                React.createElement("img", { src: img$b, className: "w-[16px] h-[16px] mr-1" }),
                                " Capture")),
                        (setCamDevices === null || setCamDevices === void 0 ? void 0 : setCamDevices.length) > 1 && (React.createElement(ButtonGlobal, { onClick: switchCamera, className: "cam_btn" }, "Switch Camera"))))))));
};
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(Formik, { initialValues: formValues, validationSchema: aadhaarConsentSchema, onSubmit: (formData) => {
                ...
                React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "name", value: values.name, onChange: handleChange('name'), id: "name", type: "text", placeholder: "" }),
                errors.name && touched.name ? React.createElement("div", { className: "text-red" }, errors.name) : null,
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(Formik, { initialValues: formValues, validationSchema: ConfirmAadhaarNumberSchema, onSubmit: (formData) => {
                ...
                React.createElement("div", { className: "mb-7 w-[80%] xl:w-[45%]" },
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "aadhaarCardNumber", value: values.aadhaarCardNumber, onChange: handleChange('aadhaarCardNumber'), id: "username", maxLength: "12", type: "number", placeholder: "" }),
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema, onSubmit: (formData) => {
            ...
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full\t" },
                ...
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Pincode"),
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "shop_address_pincode", value: values.shop_address_pincode, onChange: handleChange('shop_address_pincode'), id: "username", type: "number", placeholder: "", maxLength: "6" }),
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: secretPinValidationSchema, onSubmit: (formData) => {
            ...
            React.createElement("span", { className: `flex flex-col sm:block` },
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "first_okekey", value: values.first_okekey, onChange: handleChange('first_okekey'), id: "username", type: "number", maxLength: "4", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "busin_drpdwn_input", name: "second_okekey", value: values.second_okekey, onChange: handleChange('second_okekey'), id: "username", type: "number", maxLength: "4", placeholder: "" }),
