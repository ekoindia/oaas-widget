    ...
    return (React.createElement("span", null,
        React.createElement(React.Fragment, null,
            React.createElement("span", { className: `${type === 'Pan' || type === 'videoRecord' ? 'flex justify-end' : 'flex'}` }, type === 'Pan' || type === 'videoRecord' ? (React.createElement(Webcam, { audio: false, mirrored: true, height: type === 'videoRecord' ? 500 : 500, width: type === 'videoRecord' ? 500 : 500, ref: webcamRef, screenshotFormat: "image/jpeg", videoConstraints: videoConstraints, className: "rounded-[10px]" })) : (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "flex flex-col jalaj" },
...
const Frontcam = ({ handleRetake, imageVal }) => {
    ...
    return (React.createElement("div", { className: "flex flex-col max-w-[60%]" },
        React.createElement("img", { src: imageVal || image, alt: "screenshot", className: "rounded-[10px] max-w-xs max-h-32" }),
...
const PanVerification = ({ stepData, handleSubmit, isDisabledCTA = false, shopTypes = [] }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("div", { className: "relative hidden sm:block mt-10" }, uploadedImage === 0 ? (cameraStatus === true && (panImage === null || panImage === void 0 ? void 0 : panImage.url) === null ? (React.createElement(Camera, { type: "pan", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: panImage })) : (React.createElement("div", { className: "documentimgstyle overflow-hidden w-[100%]" }, panImage.url !== null || undefined ? (React.createElement(Frontcam, { imageVal: panImage.url, handleRetake: () => handleRetake() })) : (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: "hidden sm:flex mt-8" },
                React.createElement(Uploadfile, { handleUpload: (files, fileData) => handleImageUpload(files, fileData) }),
        ...
        React.createElement("div", null,
            ...
            React.createElement("select", { name: "shopType", value: formValues.shopType, onChange: handleChange, id: "cars", className: "px-0.5 py-3 border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, (shopTypes === null || shopTypes === void 0 ? void 0 : shopTypes.length) > 0 &&
...
const Backcam = ({ handleRetake, imageVal }) => {
    ...
    return (React.createElement("div", { className: "flex flex-col max-w-[60%]" },
        React.createElement("img", { src: imageVal, alt: "screenshot", className: "rounded-[10px]" }),
...
const AdharVerifiction = ({ stepData, handleSubmit }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        // <div></div>
        React.createElement("div", { className: "hidden sm:flex flex-col text-center lg:flex-row " },
            cameraStatus === true && cameraType === 'front' && ((_a = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _a === void 0 ? void 0 : _a.url) == null ? (React.createElement(Camera, { type: "Aadhaar", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: aadharImages })) : (React.createElement("div", { className: "documentimgstyle xl:w-[36%] lg:[80%] w-[80%] h-[190px] mr-4 sm:w-[100%] md:w-[80%] sm:mb-8 w-72 " }, ((_b = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _b === void 0 ? void 0 : _b.url) !== null || undefined ? (React.createElement(Frontcam, { imageVal: (_c = aadharImages === null || aadharImages === void 0 ? void 0 : aadharImages.front) === null || _c === void 0 ? void 0 : _c.url, handleRetake: () => handleRetake('front') })) : (React.createElement(React.Fragment, null,
...
const VideoKYC = ({ stepData, handleSubmit, isDisabledCTA = false }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8 w-4/5" },
        React.createElement("div", { className: "text-[22px] font-[500] sm:font-[400]" }, label),
        ...
        cameraStatus === true ? (React.createElement(Camera, { handleImageCapture: handleImageCapture, imagesVal: videoKyc, type: "videoRecor", cameraType: "front" })) : (React.createElement(React.Fragment, null,
            videoKyc.url !== null || undefined ? (React.createElement(Frontcam, { imageVal: videoKyc.url, handleRetake: () => handleRetake() })) : (React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { className: "hidden sm:flex w-full mt-8" },
                    React.createElement("img", { src: String(img$5), alt: "selfie icon", className: "w-28 h-28" }),
                    React.createElement("div", { className: "relative w-[60%] ml-9 flex justify-center items-center" },
                        React.createElement(InputGlobal, { type: "search", id: "search", className: "videoKyc min-w-fit", placeholder: "Take a live photo/video with ID proof", value: image }),
    ...
    return (React.createElement("div", { className: "bg-gray-100 rounded-lg p-8 flex flex-col max-w-md mt-10 md:mt-0", id: `step_${id}_${name}` },
        ...
        ((_a = form_data === null || form_data === void 0 ? void 0 : form_data.roles) === null || _a === void 0 ? void 0 : _a.length) > 0 &&
            ((_b = form_data.roles
                ...
                React.createElement("div", { className: "mr-5 border-slate-200 border-2 p-4 rounded-full" },
