import React, { useDebugValue, useState, useEffect, useRef, useCallback, createContext, forwardRef, createElement, useContext, Children, Component, useImperativeHandle, useReducer, useMemo, useLayoutEffect } from 'react';
...
const SncdHeadermobile = ({ handleSidebarToggle }) => {
    ...
    return (React.createElement("div", { className: `${currentStep !== 0 ? 'block shadow-xl border-2 border-gray p-2' : 'hidden'} sm:hidden` },
        React.createElement("span", { className: "flex px-4" },
            currentStep !== 1 ? React.createElement("img", { src: img$f, alt: "previous_arrow", className: "bg-sky p-3 rounded-lg", onClick: () => setCurrentStepMinus() }) : '',
            React.createElement("span", { className: "w-[100%] flex justify-center" }, steps.map((val, index) => {
                return (React.createElement("span", { key: val.id }, currentStep - 1 === index ? (React.createElement("span", { className: "flex" },
                    React.createElement("span", { className: "text-white text-xs bottom-1.5 bg-sky font-medium rounded-md pl-2 pr-2 py-[6px] w-max flex mr-2 justify-center items-center mr-2" }, index + 1),
                    React.createElement("span", null,
                        React.createElement("div", { className: "text-[18px] text-sky font-[500]" }, val.label),
                        React.createElement("div", { className: "text-[15px] text-orange" }, "In-Progress")))) : ('')));
            })),
            React.createElement("img", { src: img$g, alt: "next_arrow", className: "bg-sky p-3 rounded-lg", onClick: handleSidebarToggle }))));
};

var img$e = "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='18' height='13.564' viewBox='0 0 18 13.564'%3e %3cpath id='Path_8520' data-name='Path 8520' d='M6.291%2c9.2c1.35-1.356%2c2.668-2.68%2c3.987-4q2.3-2.3%2c4.6-4.6a1.8%2c1.8%2c0%2c0%2c1%2c2.715%2c2.351c-.091.111-.2.211-.3.313L7.775%2c12.8a1.854%2c1.854%2c0%2c0%2c1-3.009-.014C3.361%2c11.378%2c1.949%2c9.978.555%2c8.561a1.793%2c1.793%2c0%2c0%2c1%2c.813-3.043%2c1.771%2c1.771%2c0%2c0%2c1%2c1.767.535Q4.553%2c7.48%2c5.977%2c8.9c.092.092.187.179.313.3' transform='translate(0 0.001)' fill='white'/%3e%3c/svg%3e";
...
const Sidebar = ({ steps, userData }) => {
    ...
    return (React.createElement("div", { className: "w-[75%] sm:w-full sm:rounded-2xl bg-white" },
        React.createElement("div", { className: "px-5 pt-5 p-5 bg-sky rounded-t-2xl" },
            React.createElement("div", { className: "flex-col" },
                ...
                React.createElement("div", { className: "w-[100%] bg-white rounded-full h-[12px] h-2.5 mb-4" },
                    React.createElement("div", { ref: progressRef, className: `bg-green h-[12px] sm:h-3.0 rounded-full` }),
            ...
            return (React.createElement("span", { key: step.id, className: `flex flex-col relative w-60 ${currentStep === step.id ? 'active' : ''} ${step.id < currentStep ? 'complete' : ''}` },
                ...
                , null,
                    React.createElement("span", { className: "flex pb-5 items-center" },
                        React.createElement("span", { className: `step ${i > 0 && step.id > currentStep ? 'disabled' : ''}` }, step.id >= currentStep ? i + 1 : React.createElement("img", { src: img$e, alt: "complete mark", className: "w-[15px] h-[15px]" })),
                        React.createElement("span", null,
...
const Welcome = ({ stepData, handleSubmit }) => {
    ...
    return (React.createElement("div", { className: "w-full min-h-[80vh] min-h-[85%] flex items-center justify-center bg-white rounded-2xl" },
        React.createElement("div", { className: "items-center text-center text-black" },
            React.createElement("img", { src: String(img$d), alt: "welcome icon", className: "flex items-center text-center h-48 w-48 h-52 w-52 mr-auto ml-auto mt-auto mb-6 mb-6" }),
            ...
            React.createElement(ButtonGlobal, { className: "bg-sky bg-black text-white font-bold mt-6 mt-8 py-2 px-8 rounded", 
                // onClick={() => {
            ...
            React.createElement("span", { className: `${type === 'Pan' || type === 'videoRecord' ? 'flex justify-end' : 'flex'}` }, type === 'Pan' || type === 'videoRecord' ? (React.createElement(Webcam, { audio: false, height: 1280, width: 1280, ref: webcamRef, screenshotFormat: "image/jpeg", videoConstraints: videoConstraints, className: "rounded-[10px]", imageSmoothing: true, mirrored: false })) : (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "flex flex-col mr-3" },
                    React.createElement(Webcam, { audio: false, 
                        // height={500}
                        // width={500}
                        ref: webcamRef, screenshotFormat: "image/jpeg", videoConstraints: videoConstraints, imageSmoothing: true, mirrored: false, className: "rounded-[10px]" }),
                    React.createElement("span", { className: `flex flex-col items-end mt-3` },
                        React.createElement(ButtonGlobal, { onClick: capture, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[10rem]" },
                            React.createElement(React.Fragment, null,
                                React.createElement("img", { src: img$b, className: "w-[16px] h-[16px] mr-1" }),
                                " Capture"))))))))));
};

var img$a = "data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' width='30' height='27.183' viewBox='0 0 30 27.183'%3e %3cpath id='Path_8521' data-name='Path 8521' d='M0%2c23.136V22.2a11.018%2c11.018%2c0%2c0%2c1%2c.663-1.825Q5.845%2c11.329%2c11.079%2c2.314A4.348%2c4.348%2c0%2c0%2c1%2c13.446.281%2c4.412%2c4.412%2c0%2c0%2c1%2c18.9%2c2.306q5.237%2c9.03%2c10.438%2c18.082a4.288%2c4.288%2c0%2c0%2c1-.129%2c4.757A4.381%2c4.381%2c0%2c0%2c1%2c25.3%2c27.183q-10.319-.006-20.637%2c0c-.176%2c0-.352%2c0-.526-.017A4.28%2c4.28%2c0%2c0%2c1%2c.518%2c24.736%2c10.52%2c10.52%2c0%2c0%2c1%2c0%2c23.136M16.642%2c10.17c0-.151.017-.405%2c0-.656A1.645%2c1.645%2c0%2c0%2c0%2c15.213%2c8a1.674%2c1.674%2c0%2c0%2c0-1.753.993%2c2.7%2c2.7%2c0%2c0%2c0-.154%2c1.349q.145%2c2.352.287%2c4.7c.052.847.087%2c1.7.169%2c2.54A1.172%2c1.172%2c0%2c0%2c0%2c14.99%2c18.64a1.216%2c1.216%2c0%2c0%2c0%2c1.233-1.064c.037-.289.027-.584.044-.876.122-2.143.246-4.286.375-6.53m-.015%2c11.353A1.658%2c1.658%2c0%2c0%2c0%2c15.006%2c19.8a1.669%2c1.669%2c0%2c0%2c0-.031%2c3.337%2c1.641%2c1.641%2c0%2c0%2c0%2c1.653-1.619' transform='translate(0 0)' fill='%23ff4040'/%3e%3c/svg%3e";
...
const Browse = ({ copyType }) => {
    ...
    return (React.createElement("div", null, panVerificationfailed === 3 ? (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "browse_img_div max-w[36rem]" },
            React.createElement("div", { className: "flex justify-start" },
                ...
                React.createElement("span", { className: "flex flex-col ml-2" },
                    ...
                    selectedFile.name))),
        React.createElement("div", { className: "block w-full p-3 mt-5 text-sm text-extrdarkgray border border-darkgray rounded-md" },
        ...
        React.createElement("div", { className: "flex" },
            React.createElement("div", { className: "w-[100%] sm:w-[32rem] sm:mr-3 p-[5px] text-sm text-black border rounded-md bg-lightred border-red" },
                React.createElement("div", { className: "flex justify-start" },
                    React.createElement("img", { src: preview, className: "w-8 h-8" }),
                    React.createElement("span", { className: "flex flex-col ml-2" },
                        React.createElement("div", { className: "text-xs text-extrdarkgray font-sans font-[300]" }, "Pan Copy"), selectedFile === null || selectedFile === void 0 ? void 0 :
                        selectedFile.name))),
            React.createElement("div", { className: "hidden sm:block h-0 w-0 mt-4 border-t-white border-b-white border-r-red border-r-[12px] border-t-[8px] border-b-[8px]" }),
            React.createElement("div", { className: "hidden sm:w-[10rem] sm:flex justify-center items-center p-2 text-white text-[12px] rounded-md bg-red" }, "You have 1 attempt left")),
        React.createElement("div", { className: "mt-2 text-[14px] sm:text-[12px] max-w-[37rem] sm:max-w-[32rem] text-extrdarkgray flex font-sans" },
            React.createElement("img", { src: img$a, alt: "alert", className: "w-6 h-6 mr-3" }),
            React.createElement("div", null,
        ...
        React.createElement("div", { className: "relative p-[5px] text-sm text-black border border-darkgray rounded-md max-w[36rem]" },
            React.createElement("div", { className: "flex justify-start" },
                React.createElement("img", { src: preview, className: "w-8 h-8" }),
                React.createElement("span", { className: "flex flex-col ml-2" },
                    React.createElement("div", { className: "text-xs text-extrdarkgray font-sans font-[300]" }, "Pan Copy"), selectedFile === null || selectedFile === void 0 ? void 0 :
                    selectedFile.name))),
        React.createElement("div", { className: "block w-full p-3 mt-5 text-sm text-extrdarkgray border border-darkgray rounded-md mb-6" },
        ...
        selectedFile ? (React.createElement("div", { className: "relative p-[5px] text-sm text-black border border-darkgray rounded-md p-2 mb-8 max-w[36rem]" },
            React.createElement("div", { className: "flex justify-start" },
                React.createElement("img", { src: preview, className: "w-8 h-8" }),
                React.createElement("span", { className: "flex flex-col ml-2" },
                    React.createElement("div", { className: "text-xs text-extrdarkgray font-sans font-[300]" }, "Pan Copy"), selectedFile === null || selectedFile === void 0 ? void 0 :
...
const Frontcam = ({ handleRetake, imageVal, type }) => {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("span", { className: "flex flex-col justify-end items-end mt-3 " },
            React.createElement(ButtonGlobal, { onClick: handleRetake, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[10rem]" },
                React.createElement(React.Fragment, null,
                    React.createElement("img", { src: img$8, alt: "retry_icon", className: "w-[16px] h-[16px]  mr-1" }),
                    " Re-Capture")))));
};
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8 xl:w-[55%] lg:w-[70%]" },
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: panSchema, onSubmit: (formData) => {
            ...
            React.createElement("div", null,
                ...
                React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "panNumber", value: values.panNumber.toUpperCase(), maxLength: "10", onChange: handleChange('panNumber'), id: "panNumber", type: "text", placeholder: "" }),
                errors.panNumber && touched.panNumber ? React.createElement("div", { className: "text-red" }, errors.panNumber) : null),
            React.createElement("div", { className: "relative sm:block mt-10" }, uploadedImage === 0 ? (cameraStatus === true && (panImage === null || panImage === void 0 ? void 0 : panImage.url) === null ? (React.createElement(Camera$1, { type: "pan", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: panImage })) : (React.createElement(React.Fragment, null, panImage.url !== null || undefined ? (React.createElement("div", { className: "flex flex-col w-[100%] md:w-[100%] lg:w-[100%] sm:w-[100%] max-[450px]:w-[100%] max-[640px]:w-[100%] max-[640px]:mb-2 md:mb-2 sm:mb-2  mr-3" },
                React.createElement(Frontcam, { imageVal: panImage.url, handleRetake: () => handleRetake() }))) : (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "p-8 text-sm text-extrdarkgray border border-darkgray rounded-md bg-gray border-dashed flex flex-col justify-center items-center overflow-hidden w-[100%]" },
                    React.createElement("img", { src: img$c, className: "w-[3rem] h-[3rem] flex-col mb-6" }),
                    ...
                    React.createElement("div", { className: "flex  mt-8" },
                        ...
                        React.createElement(ButtonGlobal, { className: "text-white text-xs bottom-1.5 bg-sky font-medium rounded-md pl-2 pr-2 py-[6px] w-max flex mr-2 justify-center items-center", onClick: () => setCameraStatus(true) },
                            React.createElement(React.Fragment, null,
                                React.createElement("img", { src: img$b, className: "h-[2vh] mr-2" }),
                                " Open Camera")))),
            ...
            React.createElement("div", { className: "mt-2" },
                ...
                React.createElement("select", { name: "shopType", value: values.shopType, onChange: handleChange('shopType'), id: "cars", className: "px-0.5 py-[9px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, (shopTypes === null || shopTypes === void 0 ? void 0 : shopTypes.length) > 0 &&
            ...
            React.createElement("div", { className: "mt-2" },
                ...
                React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "shopName", value: values.shopName, onChange: handleChange('shopName'), id: "shopName", type: "text", placeholder: "" }),
            ...
            React.createElement("span", { className: `flex flex-col items-center sm:block` },
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", disabled: isDisabledCTA }, isDisabledCTA ? 'Loading...' : primaryCTAText),
        ...
        React.createElement("div", { className: "justify-center items-center p-6 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none outline-none" },
            React.createElement("div", { className: "relative w-auto my-6 mx-auto max-w-3xl" },
                React.createElement("div", { className: "border-0 rounded-lg relative flex flex-col w-full bg-white outline-none outline-none shadow-lg" },
                    React.createElement("button", { className: "flex absolute text-lg -right-2.5 -top-2.5 bg-black text-white outline-none font-medium rounded-full p-2 bg-sky", onClick: () => setShowModal(false) },
                    ...
                    React.createElement("div", { className: "flex flex-col justify-center items-center p-5 p-10 text-center" },
                        ...
                        React.createElement("div", { className: "mt-6 sm:mt-4" },
                            React.createElement("button", { className: "bg-sky text-white bg-black text-[18px] text-[14px] px-8 py-2 rounded outline-none outline-none mr-1 mb-1 ease-linear transition-all duration-150 block inline-block text-center font-[500] font-normal", onClick: handleproceed }, "Yes, Proceed"),
...
const Backcam = ({ handleRetake, imageVal }) => {
    return (React.createElement("div", { className: "flex flex-col w-[50%] md:w-[100%] lg:w-[50%] sm:w-[100%] max-[450px]:w-[100%] max-[640px]:w-[100%] md:mb-2 sm:mb-2  mr-3" },
        ...
        React.createElement("span", { className: "flex flex-col justify-end items-end mt-3" },
            React.createElement(ButtonGlobal, { onClick: handleRetake, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[6rem]" },
                React.createElement(React.Fragment, null,
                    React.createElement("img", { src: img$8, alt: "retry_icon", className: "w-[16px] h-[16px] mr-1" }),
                    " Re-Capture")))));
};
...
const AdharVerifiction = ({ stepData, handleSubmit, isDisabledCTA }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8 w-full" },
        ...
        React.createElement("div", { className: "mt-3 text-[16px] sm:text-[14px] font-[400] sm:font-[300]" },
            description,
            React.createElement("span", { className: "text-sky" }, " .jpg, .png")),
        ...
        React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row max-[640px]:flex  max-[640px]:items-center " },
            React.createElement("div", { className: "sm:flex flex-col text-center lg:flex-row w-[90%]" },
                cameraStatus === true && cameraType === 'front' && ((_a = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.front) === null || _a === void 0 ? void 0 : _a.url) == null ? (React.createElement(Camera$1, { type: "Aadhaar", cameraType: "front", handleImageCapture: handleImageCapture, imagesVal: aadhaarImages })) : (React.createElement(React.Fragment, null, ((_b = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.front) === null || _b === void 0 ? void 0 : _b.url) !== null || undefined ? (React.createElement("div", { className: "flex flex-col w-[50%] md:w-[100%] lg:w-[50%] sm:w-[100%] max-[450px]:w-[100%] max-[640px]:w-[100%] max-[640px]:mb-2 md:mb-2 sm:mb-2  mr-3" },
                    ...
                    React.createElement("div", { className: "p-8 text-sm text-extrdarkgray border border-darkgray rounded-md bg-gray border-dashed flex flex-col justify-center items-center md:w-[100%]  h-[190px] sm:w-[100%]   " },
                        React.createElement("img", { src: img$c, className: "w-[2rem] h-[2rem] flex-col mb-4" }),
                        ...
                        React.createElement("div", { className: "flex mt-4 ml-1.5" },
                            ...
                            React.createElement(ButtonGlobal, { className: "text-white text-xs bottom-1.5 bg-sky font-medium rounded-md pl-2 pr-2 py-[6px] w-max flex mr-2 justify-center items-center", onClick: () => (setCameraStatus(true), setCameraType('front'), setImage(null)) },
                                React.createElement(React.Fragment, null,
                                    React.createElement("img", { src: img$b, className: "h-[4vh] mr-2" }),
                                    " Open Camera")))),
                    frontError === true && React.createElement("div", { className: "self-start text-red" }, "Required"))))),
                cameraStatus === true && cameraType === 'back' && ((_d = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.back) === null || _d === void 0 ? void 0 : _d.url) == null ? (React.createElement(Camera$1, { type: "Aadhaar", cameraType: "back", handleImageCapture: handleImageCapture, imagesVal: aadhaarImages })) : (React.createElement(React.Fragment, null, ((_e = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.back) === null || _e === void 0 ? void 0 : _e.url) !== null || undefined ? (React.createElement(Backcam, { imageVal: (_f = aadhaarImages === null || aadhaarImages === void 0 ? void 0 : aadhaarImages.back) === null || _f === void 0 ? void 0 : _f.url, handleRetake: () => handleRetake('back') })) : (React.createElement("div", { className: "flex flex-col xl:w-[50%] lg:w-[50%] lg:mr-4 max-[640px]:mr-0 md:mr-0 max-[640px]:mb-8 sm:mb-8 " },
                    React.createElement("div", { className: "p-8 text-sm text-extrdarkgray border border-darkgray rounded-md bg-gray border-dashed flex flex-col justify-center items-center md:w-[100%]  h-[190px] sm:w-[100%]   " },
                        React.createElement("img", { src: img$c, className: "w-[2rem] h-[2rem] flex-col mb-4" }),
                        ...
                        React.createElement("div", { className: "flex mt-4 ml-1.5" },
                            ...
                            React.createElement(ButtonGlobal, { className: "text-white text-xs bottom-1.5 bg-sky font-medium rounded-md pl-2 pr-2 py-[6px] w-max flex mr-2 justify-center items-center", onClick: () => (setCameraStatus(true), setCameraType('back')) },
                                React.createElement(React.Fragment, null,
                                    React.createElement("img", { src: img$b, className: "h-[4vh] mr-2" }),
                                    " Open Camera")))),
                    backError === true && React.createElement("div", { className: "self-start text-red" }, "Required")))))))) : (React.createElement(Browse, { copyType: "Aadhaar copy" }))),
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleClickAdhar, 
...
const PanAdharMatch = () => {
    ...
    return (React.createElement(React.Fragment, null, panStatus === 0 ? (React.createElement("ul", { className: "pt-2 pl-5 text-[16px] font-[300]" },
        ...
        React.createElement("span", { className: "w-[20%] sm:w-fit" },
            React.createElement("span", { className: "rounded-[100%] w-[16vw] h-[16vw] w-16 h-16 border-2 flex justify-center items-center border-green" },
                React.createElement("img", { src: img$7, alt: "tumpup icon", className: "w-[35px] h-[35px] sm:w-7 sm:h-7" }))),
        ...
        React.createElement("span", { className: "w-[20%] sm:w-fit" },
            React.createElement("span", { className: "rounded-[100%] w-[16vw] h-[16vw] w-16 h-16 border-2 flex justify-center items-center border-red" },
                React.createElement("img", { src: img$6, alt: "tumpdown icon", className: "w-[32px] h-[32px] sm:w-7 sm:h-7" }))),
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema$1, onSubmit: (formData) => {
            ...
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full" },
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "name", value: values.name, onChange: handleChange('name'), id: "username", type: "text", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "alternate_mobile", value: values.alternate_mobile, onChange: handleChange('alternate_mobile'), id: "username", maxLength: "10", type: "number", placeholder: "" })),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Company Type"),
                    React.createElement("select", { name: "company_type", value: values.company_type, onChange: handleChange('company_type'), className: "px-0.5 py-[7px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, companyTypeData$1.map((company, idx) => {
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "authorized_signatory_name", value: values.authorized_signatory_name, onChange: handleChange('authorized_signatory_name'), id: "username", type: "text", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "contact_person_cell", value: values.contact_person_cell, onChange: handleChange('contact_person_cell'), id: "username", maxLength: "10", type: "tel", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "current_address_line1", value: values.current_address_line1, onChange: handleChange('current_address_line1'), id: "username", type: "text", placeholder: "" }),
                    errors.current_address_line1 && touched.current_address_line1 ? React.createElement("div", { className: "text-red" }, errors.current_address_line1) : null),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Registered Business address(Line2)"),
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "current_address_line2", value: values.current_address_line2, onChange: handleChange('current_address_line2'), id: "username", type: "text", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "current_address_pincode", value: values.current_address_pincode, onChange: handleChange('current_address_pincode'), maxLength: "6", id: "username", type: "number", max: "9999999", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "current_address_district", value: values.current_address_district, onChange: handleChange('current_address_district'), id: "username", type: "text", placeholder: "" }),
            ...
            React.createElement("span", { className: `${type === 'Pan' || type === 'videoRecord' ? 'flex justify-end' : 'flex'}` },
                React.createElement("div", { className: "flex flex-col mr-3" },
                    ...
                    React.createElement("div", { className: `flex justify-between mt-3` },
                        hasFlash && (React.createElement(ButtonGlobal, { onClick: toggleFlash, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[10rem]" },
                            React.createElement(React.Fragment, null,
                                "Turn Flash ",
                                flashOn ? 'Off' : 'On'))),
                        React.createElement(ButtonGlobal, { onClick: capture, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[10rem]" },
                            React.createElement(React.Fragment, null,
                                React.createElement("img", { src: img$b, className: "w-[16px] h-[16px] mr-1" }),
                                " Capture")),
                        (setCamDevices === null || setCamDevices === void 0 ? void 0 : setCamDevices.length) > 1 && (React.createElement(ButtonGlobal, { onClick: switchCamera, className: "bg-sky flex justify-center items-center text-white text-[12px] p-1 rounded-[4px] w-[10rem]" }, "Switch Camera"))))))));
};
        ...
        cameraStatus === true ? (React.createElement(Camera, { handleImageCapture: handleImageCapture, imagesVal: videoKyc, type: "videoRecor", cameraType: "front" })) : (React.createElement(React.Fragment, null,
            videoKyc.url !== null || undefined ? (React.createElement("div", { className: "flex flex-col w-[100%] max-[640px]:mb-2 md:mb-2 sm:mb-2  mr-3" },
                ...
                React.createElement("div", { className: "relative sm:hidden block w-[100%]", onClick: () => setCameraStatus(true) },
                    React.createElement("div", { className: "p-5 text-lg text-extrdarkgray border border-darkgray rounded-md bg-gray border-dashed flex flex-col justify-center items-center w-[100%] h-[180px] text-center text-[22px]" },
                        React.createElement("img", { src: img$c, className: "w-[3rem] h-[3rem] flex-col mb-6" }),
                ...
                React.createElement("div", { className: "hidden sm:flex w-full mt-8 sm:flex-col sm:items-center xl:flex-row " },
                    React.createElement("img", { src: String(img$5), alt: "selfie icon", className: "w-28 h-28" }),
                    React.createElement("div", { className: " w-full py-3 pl-2 text-sm xl:border-darkgray xl:rounded-md xl:bg-gray xl:border-dashed sm:justify-center sm:bg-white px-2 w-[60%] xl:ml-9 sm:ml-0 sm:mt-4 sm:w-[100%] flex xl:justify-between items-center" },
                        React.createElement("div", { className: "sm:hidden xl:block" }, "Take a live photo/video with ID proof"),
                        React.createElement(ButtonGlobal, { className: "text-white text-xs bg-sky hover:bg-black focus:ring-4 focus:outline-none focus:ring-sky max-h-8 min-w-fit font-medium rounded-md pl-2 pr-2 py-[6px] w-fit flex justify-center items-center", onClick: () => setCameraStatus(true) },
                            React.createElement(React.Fragment, null,
                                React.createElement("img", { src: img$b, className: "h-[2vh] mr-2" }),
                                " Open Camera")))),
            ...
            React.createElement("span", { className: `flex flex-col items-center sm:block mt-8` },
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleOnSubmit, disabled: isDisabledCTA || videoKycError }, isDisabledCTA ? 'Loading...' : primaryCTAText),
                isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step")))))));
};
...
const OnboardingStatus = ({ stepData, handleSubmit }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flex mt-8" },
            React.createElement("span", { className: "w-[20%] sm:w-fit" },
                React.createElement("span", { className: "ounded-[100%] w-[16vw] h-[16vw] w-16 h-16 flex items-center justify-center border-2 border-green" },
                    React.createElement("img", { src: img$7, alt: "thump up icon", className: "w-[35px] h-[35px] sm:w-7 sm:h-7" }))),
            React.createElement("span", { className: "flex flex-col ml-5" },
                ...
                React.createElement("span", { className: "hidden sm:flex mt-8 items-center justify-between w-[80%]" },
                    ...
                    React.createElement(ButtonGlobal, { className: "flex items-center justify-center bg-sky bg-black text-white font-semibold w-28 h-8 px-5 rounded" },
                        React.createElement(React.Fragment, null,
                            React.createElement("img", { src: img$8, alt: "retry_icon", className: "w-4 h-4 mr-2" }),
                            " Retry"))),
        ...
        React.createElement("div", { className: "sm:hidden border-2 border-gray rounded-2xl mt-6" },
            React.createElement("span", { className: "flex items-center justify-between w-[100%] border-b-2 border-gray p-5" },
                React.createElement("span", { className: "flex-col" },
                    React.createElement("div", { className: "text-md text-extrdarkgray" }, "Skipped"),
                    React.createElement("div", { className: "text-md text-black font-bold" }, "Aadhaar Verification")),
                React.createElement(ButtonGlobal, { className: "flex items-center justify-center bg-sky bg-black text-white font-[400] w-28 h-8 px-2 rounded text-[18px] py-5" },
                    React.createElement(React.Fragment, null,
                        React.createElement("img", { src: img$8, alt: "retry_icon", className: "w-4 h-4 mr-2" }),
                        " Retry"))),
...
const LoctionCapture = ({ stepData, handleSubmit, isDisabledCTA = false }) => {
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleLocation, 
                // setCapturelocationData={handleLocationCapture}
                // getLocation={true}
...
const Alert = () => {
    ...
    return (React.createElement("div", { className: "z-20 absolute top-14 top-0 backdrop-blur-[32px] left-0 bottom-0 right-0 rounded-2xl flex flex-col items-center justify-center" },
        React.createElement("span", { className: "w-32 h-32 items-center justify-center flex rounded-full border-4 border-pink" },
        ...
        React.createElement(ButtonGlobal, { className: "bg-sky bg-black text-white font-semibold mt-8 py-2 py-2 px-8 w-[80%] w-[10%] text-lg px-8 rounded", onClick: () => {
                setFinish(false);
            } }, "Go Back")));
};
...
const Fetching = () => {
    ...
    return (React.createElement("div", { className: "z-20 absolute top-[7.5rem] top-0 backdrop-blur-[70px] left-0 bottom-0 right-0 rounded-2xl flex flex-col items-center justify-center" },
        React.createElement("span", { className: "w-32 h-32 items-center justify-center flex rounded-full border-4 border-green" },
...
const SelectionScreen = ({ stepData, handleSubmit, isDisabledCTA }) => {
    ...
    return (React.createElement("div", { className: "bg-gray-100 rounded-lg p-8 flex flex-col max-w-md mt-10 md:mt-0", id: `step_${id}_${name}` },
        ...
        ((_a = form_data === null || form_data === void 0 ? void 0 : form_data.roles) === null || _a === void 0 ? void 0 : _a.length) > 0 &&
            ((_b = form_data.roles
                .filter((role) => role.isVisible)) === null || _b === void 0 ? void 0 : _b.map((role, idx) => (React.createElement("div", { className: "flex mb-5", key: `${idx}_${role.id}` },
        ...
        React.createElement(ButtonGlobal, { className: "bg-sky bg-black text-white font-bold mt-6 mt-8 py-2 px-8 rounded", onClick: () => {
    ...
    return (React.createElement("div", { className: "w-full min-h-[80vh] sm:min-h-[85%] flex items-center justify-center bg-white rounded-2xl" },
        React.createElement("div", { className: "items-center text-center text-black" },
            ...
            React.createElement("p", { className: "sm:font-normal text-[18px] pt-2 pl-4 pr-4" },
                React.createElement("span", { className: "sm:block" }, "Happy to see you here. Lets start your onboarding journey."),
                React.createElement("span", { className: "sm:block" }, " We ensure, you'll be assisted at every step.")),
            React.createElement(ButtonGlobal, { className: "bg-sky bg-black text-white font-bold mt-6 mt-8 py-2 px-8 rounded", disabled: isDisabledCTA, onClick: openPopupTab }, isDisabledCTA ? 'Loading...' : stepData === null || stepData === void 0 ? void 0 : stepData.primaryCTAText))));
};
    ...
    return (React.createElement("div", { className: "pt-8 sm:p-8" },
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(Formik, { initialValues: formValues, validationSchema: aadhaarConsentSchema, onSubmit: (formData) => {
                ...
                React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "name", value: values.name, onChange: handleChange('name'), id: "name", type: "text", placeholder: "" }),
                errors.name && touched.name ? React.createElement("div", { className: "text-red" }, errors.name) : null,
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
                isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step"))))))));
};
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(Formik, { initialValues: formValues, validationSchema: ConfirmAadhaarNumberSchema, onSubmit: (formData) => {
                ...
                React.createElement("div", { className: "mb-7 w-[80%] xl:w-[45%]" },
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "aadhaarCardNumber", value: values.aadhaarCardNumber, onChange: handleChange('aadhaarCardNumber'), id: "username", maxLength: "12", type: "number", placeholder: "" }),
                    errors.aadhaarCardNumber && touched.aadhaarCardNumber ? React.createElement("div", { className: "text-red" }, errors.aadhaarCardNumber) : null),
                ...
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px] mt-10", disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
                isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step"))))))));
};
        ...
        React.createElement("span", { className: `flex flex-col items-center sm:block` },
            React.createElement(Formik, { initialValues: formValues, validationSchema: aadhaarNumberVerifySchema, onSubmit: (formData) => {
                ...
                React.createElement("div", { className: "mb-7 w-[65%]" },
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", maxLength: "6", name: "otpVal", value: values.otpVal, onChange: handleChange('otpVal'), id: "otp", type: "number", placeholder: "" }),
                ...
                React.createElement("div", { className: "mb-7 w-[65%]" },
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "shareCode", value: values.shareCode, onChange: handleChange('shareCode'), maxLength: "4", id: "shareCode", type: "number", placeholder: "" }),
                    errors.shareCode && touched.shareCode ? React.createElement("div", { className: "text-red" }, errors.shareCode) : null),
                React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px] mt-10", disabled: isDisabledCTA }, isDisabledCTA ? 'Please wait...' : primaryCTAText),
                isSkipable && (React.createElement(ButtonGlobal, { className: "font-semibold sm:ml-10 mt-6", onClick: handleSkip }, "Skip this step"))))))));
};
...
const BusinessMerchant = ({ stepData, handleSubmit, isDisabledCTA = false, shopTypes = [], stateTypes = [] }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Formik, { initialValues: formValues, validationSchema: SignupSchema, onSubmit: (formData) => {
            ...
            React.createElement(ButtonGlobal, { className: "bg-sky hover:bg-black text-white font-semibold mt-3 mb-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]", onClick: handleLocation, type: "button" }, "Location Capture"),
            React.createElement("div", { className: "xl:grid xl:grid-cols-2 sm:flex sm:flex-col gap-4 xl:w-full\t" },
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Full Name(as per your panCard)"),
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none mb-0", name: "name", value: values.name, onChange: handleChange('name'), id: "username", type: "text", placeholder: "" }),
                    errors.name && touched.name ? React.createElement("div", { className: "text-red" }, errors.name) : null),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Gender"),
                    React.createElement("select", { name: "gender", value: values.gender, onChange: handleChange('gender'), id: "cars", className: "px-0.5 py-[8px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, genderData.map((gender, idx) => {
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("select", { name: "businessType", value: values.businessType, onChange: handleChange('businessType'), id: "cars", className: "px-0.5 py-[8px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, companyTypeData.map((company, idx) => {
                        return (React.createElement("option", { value: company.value, key: `${idx}_${company.value}` }, company.label));
                    }))),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Business Address"),
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "shop_address_line2", value: values.shop_address_line2, onChange: handleChange('shop_address_line2'), id: "username", type: "text", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "shop_landmark", value: values.shop_landmark, onChange: handleChange('shop_landmark'), id: "username", type: "text", placeholder: "" })),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "Pincode"),
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "shop_address_pincode", value: values.shop_address_pincode, onChange: handleChange('shop_address_pincode'), id: "username", type: "number", placeholder: "", maxLength: "6" }),
                ...
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "City"),
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "sender_district", value: values.sender_district, onChange: handleChange('sender_district'), id: "username", type: "text", placeholder: "" }),
                    errors.sender_district && touched.sender_district ? React.createElement("div", { className: "text-red" }, errors.sender_district) : null),
                React.createElement("div", null,
                    React.createElement(Labelglobal, { className: "block text-black text-sm font-bold mb-2" }, "State"),
                    React.createElement("select", { name: "sender_state", value: values.sender_state, onChange: handleChange('sender_state'), className: "px-0.5 py-[8px] border-2 border-gray-800 w-full rounded-md bg-white border-gray" }, stateTypes.map((state, idx) => {
                        return (React.createElement("option", { value: state.value, key: `${idx}_${state.value}` }, state.label));
                    })))),
            React.createElement(ButtonGlobal, { className: "bg-sky bg-black text-white font-bold mt-6 mt-8 py-2 px-8 rounded", disabled: isDisabledCTA }, isDisabledCTA ? 'Loading...' : stepData === null || stepData === void 0 ? void 0 : stepData.primaryCTAText))))));
};
        ...
        React.createElement(Formik, { initialValues: formValues, validationSchema: secretPinValidationSchema, onSubmit: (formData) => {
            ...
            React.createElement("span", { className: `flex flex-col sm:block` },
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "first_okekey", value: values.first_okekey, onChange: handleChange('first_okekey'), id: "username", type: "number", maxLength: "4", placeholder: "" }),
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(InputGlobal, { className: "block w-full border-2 border-gray rounded py-2 px-3 mb-2 leading-tight outline-none", name: "second_okekey", value: values.second_okekey, onChange: handleChange('second_okekey'), id: "username", type: "number", maxLength: "4", placeholder: "" }),
...
const HomePage = ({ sideBarToggle, setSideBarToggle, handleSubmit, stepResponse, shopTypes, selectedMerchantType, stateTypes, handleStepCallBack, userData }) => {
...
const Home = ({ defaultStep = '12400', handleSubmit, isBranding = true, stepResponse, shopTypes = [], selectedMerchantType, stateTypes = [], handleStepCallBack, userData, stepsData }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: `${currentStep === 0 ? 'bg-gray' : 'bg-white'} sm:bg-gray w-full min-h-screen` },
            ...
            React.createElement(HomePage, { sideBarToggle: sideBarToggle, setSideBarToggle: setSideBarToggle, handleSubmit: handleSubmit, stepResponse: stepResponse, shopTypes: shopTypes, stateTypes: stateTypes, selectedMerchantType: selectedMerchantType, handleStepCallBack: handleStepCallBack, userData: userData }))));
};

export { Home, SelectionScreen };
