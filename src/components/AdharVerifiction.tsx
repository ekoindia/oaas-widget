                ...
                {uploadedImage === 0 ? (
                    cameraStatus === true ? (
                        ...
                        <>
                            ...
                            <div className="attmp_alt">You will get only one attempt for Aadhaar verification</div>
                        </>
                    )
                ) : (
                ...
                {uploadedImage === 0 ? (
                    cameraStatus === true ? (
                        ...
                        <div className="hidden sm:flex flex-col text-center lg:flex-row ">
                            <div className="documentimgstyle w-[38%] h-[190px] mr-4 sm:w-[100%] md:w-[80%] lg:w-[38%] sm:mb-8">
                                ...
                                <div className="flex mt-4">
                                    <Uploadfile />
                                    <ButtonGlobal className="documentbtn" onClick={() => (setCameraStatus(true), setCameraType('front'))}>
                                        <>
                            ...
                            <div className="documentimgstyle w-[38%] h-[190px] mr-4  sm:w-[100%] md:w-[80%] lg:w-[38%]">
                                <img src={camera} className="w-[2rem] h-[2rem] flex-col mb-4" />
