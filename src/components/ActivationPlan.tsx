    ...
    return (
        <div className="pt-8 sm:p-8">
            ...
            <span className={`flex flex-col items-center sm:block`}>
                <div></div>
                <ButtonGlobal className="bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]" onClick={handleActivationPlan} disabled={isDisabledCTA}>
