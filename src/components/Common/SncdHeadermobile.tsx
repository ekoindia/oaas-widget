...
const SncdHeadermobile = ({ handleSidebarToggle }: SncdHeadermobileProps) => {
    ...
    return (
        <div className={`${currentStep !== 0 ? 'block shadow-xl border-2 border-gray p-2' : 'hidden'} sm:hidden`}>
            <span className="flex px-4">
                ...
                <img src={nextarrow} alt="next_arrow" className="bg-sky p-3 rounded-lg" onClick={handleSidebarToggle} />
            </span>
        </div>
    );
};
