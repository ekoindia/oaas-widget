                ...
                <span className={`${type === 'Pan' || type === 'videoRecord' ? 'flex justify-end' : 'flex'}`}>
                    <div className="flex flex-col mr-3">
                        ...
                        <div className={`flex justify-between mt-3`}>
                            {hasFlash && (
                                <ButtonGlobal onClick={toggleFlash} className="text-[12px] p-1 rounded-[4px] w-[10rem]">
                                    <>Turn Flash {flashOn ? 'Off' : 'On'}</>
                                </ButtonGlobal>
                            )}
                            <ButtonGlobal onClick={capture} className="text-[12px] p-1 rounded-[4px] w-[10rem]">
                                <>
                                    <img src={filledcamera} className="w-[16px] h-[16px] mr-1" /> Capture
                                </>
                            </ButtonGlobal>
                            {setCamDevices?.length > 1 && (
                                <ButtonGlobal onClick={switchCamera} className="text-[12px] p-1 rounded-[4px] w-[10rem]">
                                    Switch Camera
                                </ButtonGlobal>
                            )}
                        </div>
