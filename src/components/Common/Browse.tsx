            ...
            {panVerificationfailed === 3 ? (
                ...
                <div className="max-w-[21rem] sm:max-w-[57rem] mb-7">
                    <div className="flex">
                        ...
                        <div className="hidden sm:block h-0 w-0 mt-4 border-t-white border-b-white border-r-red border-r-[12px] border-t-[8px] border-b-[8px]"></div>
                        <div className="hidden sm:w-[10rem] sm:flex justify-center items-center p-2 text-white text-[12px] rounded-md bg-red">You have 1 attempt left</div>
                    </div>
                ...
                <>
                    ...
                    <div className="block w-full p-3 mt-5 text-sm text-extrdarkgray border border-darkgray rounded-md mb-6">
                        <div className="sm:flex sm:justify-between items-center">
                            ...
                            {isYourPan === false ? (
                                <div>
                                    <ButtonGlobal className="bg-sky text-white mr-3 hover:bg-black brws_btn" onClick={() => (setIsYourPan(true), setManageVeriyStep())}>
                                        Yes
                                    </ButtonGlobal>
                                    <ButtonGlobal className="bg-white text-sky hover:bg-white shadow-2xl brws_btn" onClick={() => (setPanVerificationfailed(0), setSelectedFile(undefined))}>
                                        No
                                    </ButtonGlobal>
                                </div>
                            ) : (
                ...
                <>
                    {selectedFile ? (
                        <div className="relative p-[5px] text-sm text-black border border-darkgray rounded-md p-2 mb-8 max-w[36rem]">
                            <div className="flex justify-start">
                                <img src={preview} className="w-8 h-8" />
                                <span className="flex flex-col ml-2">
                                    <div className="text-xs text-extrdarkgray font-sans font-[300]">Pan Copy</div>
