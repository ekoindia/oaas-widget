                ...
                <ButtonGlobal
                    className={
                        (manageVeriyStep === 0 && btnName === 'Verify PAN') || (manageVeriyStep === 0 && btnName === 'Verify Aadhaar')
                            ? 'bg-darkgray text-white mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]'
                            : 'bg-sky hover:bg-black text-white font-semibold mt-4 py-2 px-8 rounded w-fit sm:w-fit text-[16px]'
                    }
